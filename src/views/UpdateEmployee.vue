...
export default {
  data() {
    return {
      ...
      employee_details: {} // Initialize employee_details
    };
  },
  async mounted() {
    // Your existing mounted function
  },
  methods: {
    ...
    async updateEmployeeDetails() {
      try {
        ...
        await axios.post(`http://localhost:8000/api/employee/${this.employee.employee_id}`, data);
